...
Content: 1) ODD vs SDD alignment needed in odd/tasks/model-comparison.md. 2) test-models.sh is skeleton, no real execution. 3) User hasnt chosen privacy tier yet.
